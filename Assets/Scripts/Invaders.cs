...
public class Invaders : MonoBehaviour
{
    ...
    private void Start()
    {
        //InvokeRepeating(nameof(MissileAttack), 1, 1); //ändra till att bara kallas av vissa zombies
    }
    ...
    //Skjuter slumpmässigt iväg en missil. Kolla igenom så att det passar!
    void MissileAttack()
    {
